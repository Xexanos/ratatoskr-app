...
- `ratatoskr-wordmark.svg` -- the wordmark outlines: "Ratatoskr" set in
  **Norse Bold** by Joel Carrouche. The font's freeware license permits
  ...
  offline.
- `ratatoskr-logo-dark.svg` -- color proposal for dark backgrounds (manually
  assembled, not generator-managed yet).
